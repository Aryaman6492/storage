...
func TestStorageImpl_Count(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "one type",
			key:  "/spdx.softwarecomposition.seclogic.io/sbomsyfts",
			want: 2,
		},
	}
			...
			want: &v1beta1.SBOMSyft{
				ObjectMeta: v1.ObjectMeta{
					...
					Annotations: map[string]string{
						"seclogic.io/sync-checksum": "c1cabafe2019d04e697774db7bc943c2d9012ff3ccf5ea78af2179f5558e764d",
					},
				},
			},
		},
...
func TestStorageImpl_GetList(t *testing.T) {
	objs := map[string]runtime.Object{
		...
		"/spdx.softwarecomposition.seclogic.io/sbomsyfts/other/tata": &v1beta1.SBOMSyft{
			ObjectMeta: v1.ObjectMeta{
				Name:      "tata",
				Namespace: "other",
			},
