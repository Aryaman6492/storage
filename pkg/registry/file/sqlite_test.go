...
func Test_pathToKindKey(t *testing.T) {
	...
	tests := []struct {
		...
		{
			test:      "single",
			path:      "/spdx.softwarecomposition.seclogic.io/applicationprofiles/default/replicaset-collection-85f89d8b47",
		...
		{
			test:      "namespace",
			path:      "/spdx.softwarecomposition.seclogic.io/applicationprofiles/default",
			kind:      "applicationprofiles",
			namespace: "default",
		},
		{
			test: "cluster",
			path: "/spdx.softwarecomposition.seclogic.io/applicationprofiles",
			kind: "applicationprofiles",
		},
	}
